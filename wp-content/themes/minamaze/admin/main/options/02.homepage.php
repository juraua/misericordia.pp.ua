							 ...
							 '<div class="featured">';
								...
								if ( ! empty( $slide['slide_url'] ) ) {
									echo '<div class="featured-link">',
										 '<a href="' . $slide['slide_url'] . '"><span>' . __( 'Детальніше', 'lan-thinkupthemes' ) . '</a></span>',
										 '</div>';
								}
	...
	if ( is_front_page() or thinkup_check_ishome() ) {
		...
		echo '<div id="section-home"><div id="section-home-inner">';
			...
			echo	'</div>',
					...
					'<p><a href="' . esc_url( $thinkup_homepage_section1_link ) . '" class="more-link themebutton">' . __( 'Детальніше', 'lan-thinkupthemes' ) . '</a></p>',
					'</div>',
					'</div>',
				'</article>';
			...
			echo	'</div>',
					...
					'<p><a href="' . esc_url( $thinkup_homepage_section2_link ) . '" class="more-link themebutton">' . __( 'Детальніше', 'lan-thinkupthemes' ) . '</a></p>',
					'</div>',
					'</div>',
				'</article>';
			...
			echo	'</div>',
					...
					'<p><a href="' . esc_url( $thinkup_homepage_section3_link ) . '" class="more-link themebutton">' . __( 'Детальніше', 'lan-thinkupthemes' ) . '</a></p>',
					'</div>',
					'</div>',
				'</article>';
