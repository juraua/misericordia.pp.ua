...
function thinkup_input_sticky() {
	printf( '<span class="sticky"><i class="fa fa-thumb-tack"></i><a href="%1$s" title="%2$s">' . __( 'Закріплено', 'lan-thinkupthemes' ) . '</a></span>',
...
function thinkup_input_commenttemplate( $comment, $args, $depth ) {
	...
	<li class="post pingback">
		<p><?php _e( 'Pingback:', 'lan-thinkupthemes'); ?> <?php comment_author_link(); ?><?php edit_comment_link( __( 'Редагувати', 'lan-thinkupthemes' ), ' ' ); ?></p>
	<?php
			break;
		default :
	?>
		...
		<article id="comment-<?php comment_ID(); ?>" class="comment">
			...
			<header>
				...
				<span class="comment-meta">
					...
					<?php edit_comment_link( __( 'Редагувати', 'lan-thinkupthemes' ), ' ' );
					?>
				</span>
