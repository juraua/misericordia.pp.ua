					...
					<header class="entry-header">
						<div class="entry-meta">
							<?php
								...
								printf( __( 'Опубліковано', 'lan-thinkupthemes') . '<span><time datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="' . __( 'Link to full-size image', 'lan-thinkupthemes') . '">%4$s &times; %5$s</a> in <a href="%6$s" title="' . __( 'Повернутись до ', 'lan-thinkupthemes') . '%7$s" rel="gallery">%8$s</a>',
